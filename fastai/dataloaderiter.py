...
#completely copied from pytorch, just here until fastai fixes the memory error that happes
# due to python 3.6 loading all into memory with threadpoolexecutor.map, whilst in python 3.5 it was lazy
...
def _worker_loop(dataset, index_queue, data_queue, collate_fn, seed, init_fn, worker_id, pad_idx):
            ...
            self.workers = [
                multiprocessing.Process(
                    ...
                    args=(self.dataset, self.index_queue, self.worker_result_queue, self.collate_fn,
                          base_seed + i, self.worker_init_fn, i, self.pad_idx))
